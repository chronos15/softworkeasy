...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    sWEasyAuthUserSubject.add(
      SWEasyAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<SWEasyAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  SWEasyAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = SWEasyAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    sWEasyAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
